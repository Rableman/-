...
class route_main_func:
    ...
    #共通データとデバイス情報のリストを返す
    def init(device_sum,H,W,Device1_start,Device2_start,Device3_start):
        ...
        Device2 = route_proc.route_data(Common_data.H,Common_data.W,Device2_start)
        Device3 = route_proc.route_data(Common_data.H,Common_data.W,Device3_start)
